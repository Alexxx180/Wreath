...
namespace Wreath.Controls.Tables.Disciplines.MetaTypes
{
    /// <summary>
    /// Meta types table row component
    /// </summary>
    public partial class MetaTypeRow : UserControl, INotifyPropertyChanged, IMarkable
    {
        private int _no = 1;
        public int No
        {
        ...
        {
            _tables.Tools.UnMarkRow.MetaType(Id);
        }
